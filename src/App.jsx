          ...
          <main className="w-full max-w-3xl glass-panel rounded-lg p-8 md:p-16 transition-all duration-700">
            ...
            {activeTab === 'convite' && (
              <div className="text-center space-y-12 animate-fade-in">
                <div className="space-y-6">
                  <h3 className="text-3xl md:text-4xl font-serif italic gold-gradient-text font-semibold">Venha comemorar este dia especial comigo.</h3>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-10 py-4">
                  ...
                  <div className="flex flex-col items-center gap-4">
                    ...
                    <div className="space-y-1">
                      ...
                      <span className="block text-[10px] font-bold text-[#C7A153] tracking-wider">R. Taça Jules Rimet, 20<br />Salto - SP</span>
                    </div>
                  </div>
                </div>
            ...
            {activeTab === 'presentes' && (
              <div className="animate-fade-in space-y-12">
                <div className="text-center space-y-4">
                  ...
                  <p className="font-sans text-[#FFF0B3] font-medium text-sm max-w-lg mx-auto opacity-95">Abaixo estão algumas sugestões com minhas preferências. O que me der vou receber com muito amor!</p>
                </div>
                <div className="space-y-10">
                  <div className="relative">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-4 text-sm font-medium text-[#FFF0B3]">
                      <div className="flex justify-between border-b border-[#C7A153]/30 pb-2"><span className="text-[#C7A153] font-bold">Blusinha</span> <span>Tam M</span></div>
                      <div className="flex justify-between border-b border-[#C7A153]/30 pb-2"><span className="text-[#C7A153] font-bold">Short/Calça</span> <span>Tam M (Jeans 38)</span></div>
                  ...
                  <div className="relative">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-4 text-sm font-medium text-[#FFF0B3]">
                      <div className="flex justify-between border-b border-[#C7A153]/30 pb-2"><span className="text-[#C7A153] font-bold">Brincos / Colar / Pulseira</span> <span>Prata ou Dourado</span></div>
                  ...
                  <div className="relative">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-4 text-sm font-medium text-[#FFF0B3]">
                      <div className="flex flex-col border-b border-[#C7A153]/30 pb-2"><span className="text-[#C7A153] font-bold mb-1">Perfumes / Hidratantes</span> <span className="text-xs">Nada amadeirado ou doce demais.</span></div>
              ...
              <div className="animate-fade-in space-y-10">
                ...
                <div className="glass-panel p-6 md:p-10 rounded-sm space-y-8 relative overflow-hidden">
                  ...
                  <div className="space-y-6 relative z-10">
                    <input type="text" placeholder="Seu Nome" value={currentMessage.author} onChange={(e) => setCurrentMessage({...currentMessage, author: e.target.value})} className="w-full input-elegant text-sm font-medium px-2" />
                    <textarea placeholder="Escreva sua mensagem simples aqui..." value={currentMessage.text} onChange={(e) => setCurrentMessage({...currentMessage, text: e.target.value})} className="w-full input-elegant text-sm font-medium h-24 resize-none px-2 custom-scrollbar" />
                  </div>
                  ...
                  <p className="text-[11px] text-center text-[#C7A153] italic mt-4 font-medium">✨ Dica Mágica: Escreva algo simples e clique em "Deixar Poético" para a nossa IA transformar suas palavras em um texto digno da realeza!</p>
                </div>
